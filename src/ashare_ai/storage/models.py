...
class ScoreRow(Base):
    ...
    market_index_snapshot: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
    market_regime: Mapped[str] = mapped_column(String(16), nullable=False, default="UNKNOWN")
    market_score_adjustment: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    market_risk_multiplier: Mapped[float] = mapped_column(Float, nullable=False, default=1.0)
