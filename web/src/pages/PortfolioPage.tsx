...
export function PortfolioPage() {
  ...
  const load = useCallback(async () => {
    setError('')
    try { setPortfolio(await api.portfolio(date)) }
    catch (reason) { setPortfolio(null); setError(reason instanceof Error ? reason.message : '组合加载失败') }
