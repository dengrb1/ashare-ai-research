...
export function CandidatesPage() {
  ...
  function actionFor(row: Candidate) {
    ...
    if (plan) {
      ...
      return <Link className="secondary candidate-plan-link" to={`/reports?date=${encodeURIComponent(date)}&run_id=${encodeURIComponent(run?.run_id || '')}`}>查看方案</Link>
    }
